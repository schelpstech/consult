...
<main class="main">
    ...
    <div class="hero-section">
        <div class="hero-slider owl-carousel owl-theme">
            ...
            <!-- Slide 1 -->
            <div class="hero-single" style="background: url(assets/img/bg/class.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-lg-7">
                            <div class="hero-content">
                                <h6 class="hero-sub-title" data-animation="fadeInDown" data-delay=".25s">
                                    <i class="far fa-book-open-reader"></i>Welcome to OWUTECH Consults
                                </h6>
                                <h1 class="hero-title" data-animation="fadeInRight" data-delay=".50s">
                                    Connecting Learners to <span>Partner Institutions</span>
                                </h1>
                                <p data-animation="fadeInLeft" data-delay=".75s">
                                    We bridge the gap between aspiring students and reputable universities and colleges —
                                    simplifying admissions, partnerships, and academic success across Africa and beyond.
                                </p>
                                <div class="hero-btn" data-animation="fadeInUp" data-delay="1s">
                                    <a href="about.php" class="theme-btn">Discover More <i class="fas fa-arrow-right-long"></i></a>
                                    <a href="institutions.php" class="theme-btn theme-btn2">Find Institutions <i class="fas fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Slide 2 -->
            <div class="hero-single" style="background: url(assets/img/bg/graduate.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-lg-7">
                            <div class="hero-content">
                                <h6 class="hero-sub-title" data-animation="fadeInDown" data-delay=".25s">
                                    <i class="far fa-graduation-cap"></i>Empowering Students
                                </h6>
                                <h1 class="hero-title" data-animation="fadeInRight" data-delay=".50s">
                                    Study with Confidence and <span>Accredited Partners</span>
                                </h1>
                                <p data-animation="fadeInLeft" data-delay=".75s">
                                    Explore fully accredited programs and gain access to recognized institutions committed
                                    to your educational growth and global opportunities.
                                </p>
                                <div class="hero-btn" data-animation="fadeInUp" data-delay="1s">
                                    <a href="institutions.php" class="theme-btn">Explore Institutions <i class="fas fa-arrow-right-long"></i></a>
                                    <a href="contact.php" class="theme-btn theme-btn2">Get Assistance <i class="fas fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Slide 3 -->
            <div class="hero-single" style="background: url(assets/img/bg/online.jpg)">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 col-lg-7">
                            <div class="hero-content">
                                <h6 class="hero-sub-title" data-animation="fadeInDown" data-delay=".25s">
                                    <i class="far fa-handshake"></i>Trusted Partnerships
                                </h6>
                                <h1 class="hero-title" data-animation="fadeInRight" data-delay=".50s">
                                    Building Strong <span>Academic Collaborations</span>
                                </h1>
                                <p data-animation="fadeInLeft" data-delay=".75s">
                                    We partner with institutions to promote quality education delivery, academic visibility,
                                    and student access to globally competitive learning opportunities.
                                </p>
                                <div class="hero-btn" data-animation="fadeInUp" data-delay="1s">
                                    <a href="partners.php" class="theme-btn">Our Partners <i class="fas fa-arrow-right-long"></i></a>
                                    <a href="contact.php" class="theme-btn theme-btn2">Partner With Us <i class="fas fa-arrow-right-long"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">100% Online</h4>
                            <p>Study conveniently from anywhere with our fully online learning environment designed for flexibility and accessibility.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-item active wow fadeInDown" data-wow-delay=".25s">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">Flexible Study</h4>
                            <p>Balance your learning with work and family commitments. Our flexible schedules allow you to learn at your own pace.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-item wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">Accredited Courses</h4>
                            <p>All our programmes are fully accredited, ensuring that your qualification is recognized and respected globally.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="feature-item wow fadeInDown" data-wow-delay=".25s">
                        ...
                        <div class="feature-content">
                            <h4 class="feature-title">Flexible & Affordable</h4>
                            <p>Enjoy quality education at an affordable cost with flexible payment options designed to suit your financial goals.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="about-right wow fadeInRight" data-wow-delay=".25s">
                        ...
                        <div class="about-bottom">
                            <a href="about.html" class="theme-btn">Discover More
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="counter-box">
                        ...
                        <div>
                            <span class="counter" data-count="+" data-to="750" data-speed="3000">50</span>
                    ...
                    <div class="faq-right">
                        <div class="site-heading mb-3">
                            <span class="site-title-tagline justify-content-start">
                                <i class="far fa-book-open-reader"></i> FAQs
                            </span>
                            <h2 class="site-title my-3">Frequently Asked <span>Questions</span></h2>
                        </div>
                        <p class="mb-3">
                            Below are some of the most common questions prospective students ask about our
                            admission process, study modes, and scholarship opportunities.
                            Owutech Consult is here to make your university admission seamless and stress-free.
                        </p>
                        <p class="mb-4">
                            Whether you’re applying for full-time, part-time, or distance learning programs,
                            our experienced counselors will guide you through every step—from choosing the right
                            university to completing your registration.
                        </p>
                        <a href="contact.html" class="theme-btn mt-2">Ask Your Question</a>
                    </div>
                </div>
                <div class="col-lg-6">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span><i class="far fa-question"></i></span> How do I apply for admission?
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show"
                                aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    You can apply through Owutech Consult by visiting our office or contacting our
                                    admission support team. We will guide you through the documentation, university
                                    selection, and registration steps for your chosen program.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span><i class="far fa-question"></i></span> Can I apply without writing UTME?
                                </button>
                            </h2>
                            <div id="collapseTwo" class="accordion-collapse collapse"
                                aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes. Through programs like JUPEB, Diploma, or Direct Entry, you can gain admission
                                    into 100-level or 200-level without UTME. We’ll advise you on the best entry path
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span><i class="far fa-question"></i></span> Are there scholarship opportunities?
                                </button>
                            </h2>
                            <div id="collapseThree" class="accordion-collapse collapse"
                                aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes. Atiba University and West Midlands Open University both offer
                                    Founder’s Scholarships covering up to 50% of tuition for qualified and
                                    deserving students. Our team will help you apply for available scholarships.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="headingFour">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    <span><i class="far fa-question"></i></span> What are the study modes available?
                                </button>
                            </h2>
                            <div id="collapseFour" class="accordion-collapse collapse"
                                aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Students can choose between Full-Time, Open and Distance Learning (ODL),
                                    or 100% Online Study Modes depending on their schedule and location.
                                    We’ll help you select the most flexible option for your lifestyle.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="site-heading text-center">
                        ...
                        <h2 class="site-title">What Our <span>Students Say</span></h2>
                        <p>Real stories from students who secured admission and are thriving through
                            Owutech Consult’s guidance.</p>
                    </div>
                </div>
            </div>
            <div class="testimonial-slider owl-carousel owl-theme">
                <div class="testimonial-item">
                    ...
                    <div class="testimonial-quote">
                        <p>
                            Owutech Consult made my admission process into Atiba University smooth and stress-free.
                            They guided me through every step and helped me secure a Founder’s Scholarship.
                        </p>
                    </div>
                    <div class="testimonial-content">
                        ...
                        <div class="testimonial-author-info">
                            <h4>Grace Adebayo</h4>
                            <p>BSc. Microbiology, Atiba University</p>
                        </div>
                    </div>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="testimonial-quote">
                        <p>
                            Thanks to Owutech Consult, I was able to enroll in the West Midlands Open University
                            online BSc program while working full-time. Their support team is top-notch.
                        </p>
                    </div>
                    <div class="testimonial-content">
                        <div class="testimonial-author-img">
                        ...
                        <div class="testimonial-author-info">
                            ...
                            <p>BSc. Information Systems, WMOU</p>
                        </div>
                    </div>
                    <span class="testimonial-quote-icon"><i class="far fa-quote-right"></i></span>
                </div>
                ...
                <div class="testimonial-item">
                    ...
                    <div class="testimonial-quote">
                        <p>
                            I had incomplete O’Level results, but Owutech Consult showed me alternative
                            entry routes through JUPEB. Now I’m a proud student of Computer Science.
                        </p>
                    </div>
                    <div class="testimonial-content">
                        <div class="testimonial-author-img">
                        ...
                        <div class="testimonial-author-info">
                            <h4>Rita Adeola</h4>
                            <p>JUPEB Student, Atiba University</p>
                        </div>
                    </div>
                    <span class="testimonial-quote-icon"><i class="far fa-quote-right"></i></span>
                </div>
